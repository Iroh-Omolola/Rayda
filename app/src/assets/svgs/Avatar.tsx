...
export const Avatar = (props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
  <svg
    width={176}
    height={176}
    viewBox="0 0 176 176"
    ...
    {...props}
  >
    <g filter="url(#filter0_dd_1_19961)">
      <rect
        x={16}
        y={4}
        width={144}
    ...
    <defs>
      ...
      >
        ...
        <feMorphology
          ...
          operator="erode"
          in="SourceAlpha"
          result="effect1_dropShadow_1_19961"
        />
        <feOffset dy={4} />
        ...
        <feMorphology
          ...
          operator="erode"
          in="SourceAlpha"
          result="effect2_dropShadow_1_19961"
        />
        <feOffset dy={12} />
        ...
        <feBlend
          mode="normal"
          in2="effect1_dropShadow_1_19961"
          result="effect2_dropShadow_1_19961"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect2_dropShadow_1_19961"
          result="shape"
        />
      </filter>
      <pattern
        ...
        height={1}
      >
        <use xlinkHref="#image0_1_19961" transform="scale(0.003125)" />
      </pattern>
      <image
        id="image0_1_19961"
        width={320}
